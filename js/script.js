                ...
                <div class="card shadow-sm">
                  ...
                  <h2>${element.name.common}</h2>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <p class=p-2 fw-light">population:<br>${element.population}</p>
                       <a href='${element.maps.googleMaps}'> <button type="button" class="btn btn-sm btn-outline-secondary ">Map</button></a>
                      </div>
